        ...
        <div class="form">
            ...
            <?= csrf_field() ?>
                ...
                <div class="input-div">
                    ...
                    <input class="input" type="email" name="email" id="newemail" placeholder="Enter Your E-mail Here" required>
                    <i id="user-icon" class="fas fa-user"></i>
                    <div class="error"></div>
                </div> 
                <div class="input-div">
                    <label class="label" for="password">Choose A Password</label>
                    <input class="input" type="password" name="password" id="newpassword" placeholder="Enter Your Password Here" required>                    
