...
/*                      foreach ($cartItems as $item):
                    */?><!--
                    ...
                    <li class="flex py-6">
                      ...
                      <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                        ...
                        <img src="images/frame5.png" alt="Cart item" class="h-full w-full object-cover object-center">
                      </div>
                      ...
                      <div class="ml-4 flex flex-1 flex-col">
                        <div>
                          <div class="flex justify-between text-base font-medium text-gray-900">
                            <h3>
                              <!--          Function that returns the name of an item that was placed in the user's cart. Concatenate the manufacturer and model-->
                              <a href="#"> <?php
                                  /* Cart::name*/ ?> Hyundai Palisade</a>
                            </h3>
                            <p class="ml-4"><!--Price for singular item--> $33,600</p>
                          </div>
                          <p class="mt-1 text-sm text-gray-500"> <!-- Colour of the vehicle -->Silver</p>
                          <p class="mt-1 text-sm text-gray-500"><!--Year of manufacture--> 2022</p>
                        </div>
                        <div class="flex flex-1 items-end justify-between text-sm">
                          <p class="text-gray-500"> <!-- Quantity of ordered vehicles. Create a component to scroll through numbers -->Qty 1</p>
                    ...
                    <li class="flex py-6">
                      ...
                      <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                        <!--    Source attribute to be filled with the path to the item-->
                        <img src="images/frame6.png" alt="Cart item" class="h-full w-full object-cover object-center">
                      </div>
                        ...
                        <div>
                          <div class="flex justify-between text-base font-medium text-gray-900">
                            <h3>
                              <!--          Function that returns the name of an item that was placed in the user's cart. Concatenate the manufacturer and model-->
                              <a href="#"> <?php
                                  /* Cart::name*/ ?>Toyota Rav 4</a>
                            </h3>
                            <p class="ml-4"><!--Price for singular item--> $30,600</p>
                          </div>
                          <p class="mt-1 text-sm text-gray-500"> <!-- Colour of the vehicle -->Silver</p>
                          <p class="mt-1 text-sm text-gray-500"><!--Year of manufacture--> 2022</p>
                        </div>
                    ...
                    <li class="flex py-6">
                      ...
                      <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                        <!--    Source attribute to be filled with the path to the item-->
                        <img src="images/range_rover_sv_serenity_p530_lwb_2023_4k-HD.jpg" alt="Cart item" class="h-full w-full object-cover object-center">
                      </div>
                        ...
                        <div>
                          <div class="flex justify-between text-base font-medium text-gray-900">
                            <h3>
                              <!--          Function that returns the name of an item that was placed in the user's cart. Concatenate the manufacturer and model-->
                              <a href="#"> <?php
                                  /* Cart::name*/ ?> Range rover Sport</a>
                            </h3>
                            <p class="ml-4"><!--Price for singular item--> $53,000</p>
                          </div>
                          <p class="mt-1 text-sm text-gray-500"> <!-- Colour of the vehicle -->White</p>
                          <p class="mt-1 text-sm text-gray-500"><!--Year of manufacture--> 2022</p>
                        </div>
                        <div class="flex flex-1 items-end justify-between text-sm">
                          <p class="text-gray-500"> <!-- Quantity of ordered vehicles. Create a component to scroll through numbers -->Qty 1</p>
            ...
            <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
              <div class="flex justify-between text-base font-medium text-gray-900">
                <p>Total</p>
                <p><!--Total Price for cart items--> $117,200</p>
              </div>
